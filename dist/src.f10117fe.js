...
inputFile.addEventListener("change", function (ev) {
  ...
  reader.onload = function (e) {
    ...
    image.onload = function () {
      ...
      var r = image.width > image.height ? image.width / 2 : image.height / 2;
      var grad = ctx.createRadialGradient(image.width / 2, image.height / 2, r / 2, image.width / 2, image.height / 2, r);
...
var dlBtn = document.querySelector("button");
